...
* 이 책의 강의용 PDF 파일이 제공됩니다. [여기](https://github.com/stepanowon/vuejs_book_ppt/archive/master.zip)를 클릭하여 다운로드하세요.
...
확장 프로그램을 사용 중지하려면 사용 설정됨 체크박스를 선택 해제하고 확장 프로그램을 사용 설정하려면 체크박스를 선택합니다.
