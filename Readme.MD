...
* webpack에서 사용하던 babel-preset-es2015는 deprecated로 공지되었습니다. 이제는 babel-preset-env를 사용해야 합니다. env를 사용하면 ES2017+ 문법을 모두 사용할 수 있습니다. 코드에서 변경해야 할 부분은 [여기](http://babeljs.io/env#upgrading-to-babel-preset-env)를 참조하세요.
